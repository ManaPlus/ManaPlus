...
run "-DENABLE_LIBXML -DEATHENA_SUPPORT -DTMWA_SUPPORT -DUSE_X11 -DDYECMD" "$includes" "$1"
...
run "-DENABLE_PUGIXML -DEATHENA_SUPPORT -DTMWA_SUPPORT -DUSE_X11 -DDYECMD" "$includes" "$1"
...
run "-DENABLE_LIBXML -DEATHENA_SUPPORT -DUSE_SDL2 -DTMWA_SUPPORT -DUSE_X11 -DDYECMD" "$includes" "$1"
...
run "-DENABLE_PUGIXML -DEATHENA_SUPPORT -DUSE_SDL2 -DTMWA_SUPPORT -DUSE_X11 -DDYECMD" "$includes" "$1"
